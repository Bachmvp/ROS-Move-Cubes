...
def open():
    ...
    for i in range(3):
        ...
        rate.sleep()
    print
    'LOOK! The gripper is opened now.'
...
def close():
    ...
    for i in range(3):
        ...
        rate.sleep()
    print
    'LOOK! The gripper is closed now.'
...
print
'Now we have ' + str(model_number - 3) + ' cubes.'
# move each cube
